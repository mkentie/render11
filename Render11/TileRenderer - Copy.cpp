...
bool TileRenderer::Init()
{
    ...
    {
        {"Position", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, offsetof(Tile, XYPos), D3D11_INPUT_PER_INSTANCE_DATA, 1},
        {"Texcoord", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, offsetof(Tile, TexCoord), D3D11_INPUT_PER_INSTANCE_DATA, 1},
        {"Texcoord", 1, DXGI_FORMAT_R32_FLOAT, 0, offsetof(Tile, Z), D3D11_INPUT_PER_INSTANCE_DATA, 1},
    };
...
void TileRenderer::Draw()
{
    ...
    m_DeviceContext.DrawInstanced(4, m_iIndex, 0, 0);
}
